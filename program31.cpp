...
class DoublyCL : public LinkedList  // public inheritance
{
  private:
     PNODE Last;
...
void DoublyCL ::InsertFirst(int ino)
{
  ...
  Last->next=First;  // to maintain circular nature
  First->prev=Last;  // to maintain circular nature
  iCount++;
}
...
int main()
{
    ...
    obj.Display();
    cout<<"Lenght of LL is"<<obj.Count()<<"\n";
